...
import { defaultImages } from '../utils/defaultProjectImages.js';
...
export const createProject = async (req, res) => {
    try {
        ...
        // =========================================================
        // === LOGIC CHỌN ẢNH NGẪU NHIÊN ĐƯỢC THÊM VÀO ĐÂY ===
        // =========================================================
        let finalImage = img; // 1. Lấy link ảnh từ người dùng

        if (!finalImage) { // 2. Kiểm tra nếu người dùng không nhập link
            // Chọn một ảnh ngẫu nhiên từ kho ảnh
            const randomIndex = Math.floor(Math.random() * defaultImages.length);
            finalImage = defaultImages[randomIndex]; // 3. Gán ảnh ngẫu nhiên
        }
        // =========================================================
        ...
        const newProject = new Project({
            title,
            dec,
            img: finalImage, // 4. Sửa ở đây: dùng biến finalImage đã qua xử lý
